...
PARSING_SRCS = $(addprefix parsing/, expand.c expand_utils.c parsing_utils.c lexer.c tokenizer.c parser_utils.c parse_redirections.c)
ENV_SCRS = $(addprefix env/, env.c env_utils.c)
EXEC_SRCS = $(addprefix execution/, 3d_split.c get_path.c tools.c file_path.c)
SRCS = main.c freee.c freee2.c error_handler.c array_utils.c $(BUILIN_SRCS) $(PARSING_SRCS) $(ENV_SCRS) $(EXEC_SRCS) ft_malloc.c
OBJS = $(SRCS:.c=.o)
