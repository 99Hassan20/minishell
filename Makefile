CC = cc
CFLAGS = -Wall -Werror -Wextra -I./includes -g #-fsanitize=address -g
NAME = minishell
LIBFT = -L./libft -lft
...
PARSING_SRCS = $(addprefix parsing/, expand.c expand_utils.c lexer_utils.c lexer.c tokenizer.c parser_utils.c parse_redirections.c parse_redirections2.c)
